...
This repository includes a structured design package for **Bare-Metal RTOS Scheduling**. The package captures the system boundary, runtime flow, hardware/software interfaces, validation strategy, and implementation roadmap.
