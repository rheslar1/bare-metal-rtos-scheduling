# Bare-Metal RTOS Scheduling Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for Bare-Metal RTOS Scheduling. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Multi-threaded FreeRTOS or Zephyr application with queues, mutexes, semaphores, interrupt handoff, and priority inversion notes. | Scenario tests and documentation review. |
