...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Bare-Metal RTOS Scheduling. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Multi-threaded FreeRTOS or Zephyr application with queues, mutexes, semaphores, interrupt handoff, and priority inversion notes. | Scenario tests and documentation review. |
