# Bare-Metal RTOS Scheduling Runtime Design
...
1. Build a runtime profile for `bare-metal-rtos-scheduling`.
...
The runtime must make this focus measurable through logs, reports, tests, diagrams, or hardware captures. The proof point for review is: Real concurrency, deterministic task design, shared-resource safety, and explainable scheduler tradeoffs.
