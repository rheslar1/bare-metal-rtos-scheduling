# Bare-Metal RTOS Scheduling Deep Architecture
...
C++17, C++ Design Patterns, SOLID, FreeRTOS, Zephyr, IPC, Mutexes, Semaphores, Priority inheritance
...
- Test coverage: `tests/SchedulerTests.cpp`
